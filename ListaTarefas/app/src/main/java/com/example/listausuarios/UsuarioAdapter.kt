...
class UsuarioAdapter(var listaUsuario: MutableList<Tarefa>):RecyclerView.Adapter<UsuarioAdapter.ItemViewHolder>() {
...
//dado/propriedade/atributo da lista
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.txtPeriodo.text = listaUsuario[position].senioridade.nome
    }
